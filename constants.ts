...
// Available Reciters with Primary and Backup sources
export const RECITERS: Reciter[] = [
  { 
    id: 'sudais', 
    name: 'Abdul Rahman Al-Sudais', 
    folder: 'abdul_rahman_alsudais',
    fallbackServer: 'https://server11.mp3quran.net/',
    fallbackFolder: 'sds'
  },
  { 
    id: 'mishary', 
    ...
    fallbackServer: 'https://server8.mp3quran.net/',
    fallbackFolder: 'afs'
  },
  { 
    id: 'ghamdi', 
    name: 'Saad Al Ghamdi', 
    folder: 'sa3d_al-ghaamidee',
    fallbackServer: 'https://server7.mp3quran.net/',
    fallbackFolder: 's_gmd'
  },
  { 
    id: 'basit', 
...
export const SURAHS: Surah[] = [
  ...
  { number: 4, name: "سورة النساء", englishName: "An-Nisaa", englishNameTranslation: "The Women", numberOfAyahs: 176, revelationType: "Medinan" },
  ...
  { number: 8, name: "سورة أنفال", englishName: "Al-Anfal", englishNameTranslation: "The Spoils of War", numberOfAyahs: 75, revelationType: "Medinan" },
  ...
  { number: 14, name: "سورة ابراهيم", englishName: "Ibrahim", englishNameTranslation: "Abraham", numberOfAyahs: 52, revelationType: "Meccan" },
  ...
  { number: 76, name: "سورة الانسان", englishName: "Al-Insan", englishNameTranslation: "The Man", numberOfAyahs: 31, revelationType: "Medinan" },
  ...
  { number: 82, name: "سورة الإنفطار", englishName: "Al-Infitar", englishNameTranslation: "The Cleaving", numberOfAyahs: 19, revelationType: "Meccan" },
  ...
  { number: 84, name: "سورة الإنشقاق", englishName: "Al-Inshiqaq", englishNameTranslation: "The Sundering", numberOfAyahs: 25, revelationType: "Meccan" },
